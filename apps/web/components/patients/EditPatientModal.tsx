...
import { X, Loader2, UserX, AlertTriangle } from "lucide-react";
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          ...
          <div className="flex justify-end gap-3 border-t border-black/[0.06] dark:border-white/[0.08] pt-4">
            ...
            <Button type="submit" disabled={loading || deregistering} className="gap-2">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-xs leading-relaxed text-ink-500">
                Deregistering will immediately force log out {patient.full_name} from the mobile app and permanently prevent them from re-connecting with your Smaran caregiver code.
              </p>
              ...
              {!confirmDeregister ? (
                ...
                <div className="mt-3 rounded-lg border border-coral-300 dark:border-coral-400/40 bg-surface p-3 space-y-2">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    >
                      {deregistering && <Loader2 size={13} className="animate-spin" />}
                      Confirm Deregister
                    </Button>
                    <Button
                      type="button"
