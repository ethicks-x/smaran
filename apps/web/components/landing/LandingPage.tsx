...
export interface LandingPageProps {
  /**
   * The `.apk` asset from the newest published GitHub release, resolved
   * server-side in `app/page.tsx`. `null` when no release has shipped one yet
   * or the GitHub API couldn't be reached — the button then falls back to the
   * releases page itself instead of a stale, hand-pasted download link.
   */
  apkUrl: string | null;
}

export default function LandingPage({ apkUrl }: LandingPageProps) {
  return (
    <div className="min-h-screen overflow-hidden bg-background text-ink-900">
      ...
      <section className="relative px-6 pb-24 pt-16 lg:px-8 lg:pb-32 lg:pt-24">
        ...
        <div className="pointer-events-none absolute -right-24 top-32 h-112 w-md rounded-full bg-mint-200/40 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          >
            Because Every{" "}
            <span className="bg-linear-to-r from-indigo-600 via-lavender-500 to-mint-500 bg-clip-text text-transparent">
              Memory
            </span>{" "}
            Matters.
          </motion.h1>
          ...
          >
            Smaran helps caregivers create personalized cognitive experiences
            and stay connected with the people they care for.
          </motion.p>
          ...
          >
            ...
            <Link
              href={apkUrl ?? "https://github.com/ethicks-x/smaran/releases"}
              download={apkUrl !== null}
              target={apkUrl === null ? "_blank" : undefined}
              rel={apkUrl === null ? "noopener noreferrer" : undefined}
            >
        ...
        <div className="relative mx-auto mt-20 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-3">
          {[
            ...
            },
            {
              ...
              tone: "from-mint-500 to-mint-400",
              delay: 0.6,
            },
            {
              icon: Package,
              label: "Cherished Objects",
              tone: "from-lavender-500 to-lavender-400",
              delay: 1.2,
            },
          ].map((c, i) => (
            <motion.div
      ...
      <section className="relative border-t border-black/5 dark:border-white/[0.08] bg-surface px-6 py-24 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="relative mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="pointer-events-none absolute left-0 right-0 top-8 hidden h-px bg-linear-to-r from-transparent via-indigo-300 to-transparent lg:block" />
            {[
              {
                step: "01",
                icon: UserPlus,
                title: "Share Your Smaran ID",
                desc: "The patient enters your ID in their app to request care.",
              },
              {
                step: "02",
                icon: Heart,
                title: "Preserve Their Memories",
                desc: "Add people, places, and objects that matter to them.",
              },
              {
                step: "03",
                icon: Brain,
                title: "Personalized Quizzes",
                desc: "The mobile app generates recognition games from their memories.",
              },
              {
                step: "04",
                icon: BarChart3,
                title: "Track Their Journey",
                desc: "Monitor accuracy and engagement over time.",
              },
            ].map((s, i) => (
              <motion.div
                key={s.step}
              ...
              >
                ...
                <p className="mt-4 text-xs font-bold tracking-wide text-indigo-400">
                  STEP {s.step}
                </p>
            ...
            {[
              {
                ...
                desc: "Track quiz sessions and accuracy in real time.",
                tone: "from-indigo-500 to-indigo-400",
              },
              {
                icon: Heart,
                title: "Personal Memory Library",
                desc: "Preserve people, places, and objects that matter.",
                tone: "from-coral-400 to-coral-500",
              },
              {
                icon: BarChart3,
                title: "Progress Tracking",
                desc: "Monitor engagement and accuracy with clarity.",
                tone: "from-mint-500 to-mint-400",
              },
              {
                icon: Users,
                title: "Caregiver-Centered",
                desc: "Everything needed to support loved ones in one place.",
                tone: "from-lavender-500 to-lavender-400",
              },
            ].map((f, i) => (
              <motion.div
      ...
      <section className="px-6 pb-24 lg:px-8">
        <motion.div
          ...
          className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl bg-linear-to-br from-indigo-700 via-indigo-600 to-lavender-500 px-8 py-16 text-center shadow-2xl shadow-indigo-900/30"
        >
          ...
          <p className="relative mx-auto mt-4 max-w-xl text-balance text-indigo-100">
            Join Smaran and start building a personalized cognitive care
            experience today.
          </p>
