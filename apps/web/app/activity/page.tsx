  ...
  return (
    <DashboardShell>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3 rounded-2xl border border-black/6 dark:border-white/[0.08] bg-surface p-3">
        ...
        >
          <option value="all" className="bg-surface text-ink-900">All Patients</option>
          {myPatients.map((p) => (
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        {e.patient_avatar_url ? (
                          ...
                          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-indigo-50 font-display text-sm font-semibold text-indigo-700">
