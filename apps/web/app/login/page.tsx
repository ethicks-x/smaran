  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-center font-display text-2xl font-bold text-ink-900">Welcome back</h1>
        <p className="mt-1.5 text-center text-sm text-ink-500">Log in to continue supporting your loved ones.</p>

        <form className="mt-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
          <div>
            <label className="mb-1.5 block text-sm font-medium text-ink-700" htmlFor="email">Email</label>
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-ink-700" htmlFor="password">Password</label>
            <div className="relative">
