      ...
      <div className="grid gap-6 lg:grid-cols-2">
          ...
          <CardContent className="space-y-5">
            <div className="flex items-center gap-4">
              {isLoaded && user?.imageUrl ? (
                <img src={user.imageUrl} alt={user.fullName ?? "Profile"} className="h-16 w-16 rounded-2xl object-cover" />
              ) : (
            ...
            <p className="text-xs text-ink-500">
              Your name, email, and photo are managed through your account provider. Click below to edit them.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button variant="danger" size="sm" className="gap-1.5" onClick={() => signOut({ redirectUrl: "/" })}>
