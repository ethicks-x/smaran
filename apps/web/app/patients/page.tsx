    ...
    return (
        <DashboardShell>
            <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                    <h1 className="font-display text-2xl font-bold text-ink-900 sm:text-3xl">My Patients</h1>
                    <p className="mt-1.5 text-sm text-ink-500">Manage profiles for everyone in your care.</p>
                </div>
