 ...
 * definitions the caregiver set, and — after a reinstall — this reader's own
 * game history, come **down** (D-34). People and memories are the part still
...
async function takeDown(
	...
	try {
		...
		// Last, and only once both have been written. The watermark is a promise
		// that everything up to it has been applied, so moving it before the writes
		// land would silently skip whatever did not.
